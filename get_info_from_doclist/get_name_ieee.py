...
def get_name_ieee(
    ...
    *,
    ...
    try:
        ...
        for offset, (val1,val2) in enumerate(
            ws.iter_rows(min_row=min_row, max_row=max_row, min_col=5, max_col=6, values_only=True),
            start=min_row
        ):
...
if __name__ == "__main__":
    ...
    filename = "ieee_doc_list.xlsx"
    rows = get_name_ieee(folder_abs_path, filename,[2,5])
    # 結果を表示（例: 2,4,6）
    print(rows)